...
timestamp = []
tx_index = 5
position = np.loadtxt(filepath + '/imu_pose_noise.txt', usecols = (tx_index, tx_index + 1, tx_index + 2))

# # imu_pose   imu_spline
position1 = []
quaterntions1 = []
timestamp1 = []
data = np.loadtxt(filepath + '/vision_pose.txt')
# timestamp1 = data[:,0]
# quaterntions1 = data[:,[tx_index + 6, tx_index + 3, tx_index + 4, tx_index + 5]] # qw,qx,qy,qz
position1 = data[:,[tx_index-1, tx_index, tx_index + 1]]
...
quaterntions3 = []
timestamp3 = []
data = np.loadtxt(filepath + '/pre_imu_pose.txt')
# timestamp2 = data[:,0]
# quaterntions2 = data[:,[tx_index + 6, tx_index + 3, tx_index + 4, tx_index + 5]] # qw,qx,qy,qz
position3 = data[:,[tx_index-1, tx_index , tx_index + 1]]
